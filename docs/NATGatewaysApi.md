...
```go
var result map[string]interface{} = DatacentersNatgatewaysDelete(ctx, datacenterId, natGatewayId)
                      .Pretty(pretty)
                      .Depth(depth)
...
func main() {
    ...
    // response from `DatacentersNatgatewaysDelete`: map[string]interface{}
    fmt.Fprintf(os.Stdout, "Response from `NATGatewaysApi.DatacentersNatgatewaysDelete`: %v\n", resp)
}
```
...
```go
var result map[string]interface{} = DatacentersNatgatewaysFlowlogsDelete(ctx, datacenterId, natGatewayId, flowLogId)
                      .Pretty(pretty)
                      .Depth(depth)
                      .Execute()
```
...
func main() {
    ...
    // response from `DatacentersNatgatewaysFlowlogsDelete`: map[string]interface{}
    fmt.Fprintf(os.Stdout, "Response from `NATGatewaysApi.DatacentersNatgatewaysFlowlogsDelete`: %v\n", resp)
}
```
...
```go
var result map[string]interface{} = DatacentersNatgatewaysRulesDelete(ctx, datacenterId, natGatewayId, natGatewayRuleId)
                      .Pretty(pretty)
                      .Depth(depth)
                      .XContractNumber(xContractNumber)
                      .Execute()
...
func main() {
    ...
    // response from `DatacentersNatgatewaysRulesDelete`: map[string]interface{}
    fmt.Fprintf(os.Stdout, "Response from `NATGatewaysApi.DatacentersNatgatewaysRulesDelete`: %v\n", resp)
}
```
